...
const allProducts: Product[] = [
  {
    ...
    price: 150.0,
    category: 'Millets',
    imageUrl: 'https://placehold.co/400x400/166534/FFFFFF?text=Foxtail+Millet',
  },
  {
    id: 'p2',
    ...
    price: 120.0,
    category: 'Millets',
    imageUrl: 'https://placehold.co/400x400/166534/FFFFFF?text=Pearl+Millet',
  },
  {
    id: 'p3',
    ...
    price: 90.0,
    category: 'Flours',
    imageUrl: 'https://placehold.co/400x400/166534/FFFFFF?text=Sorghum+Flour',
  },
  {
    id: 'p4',
    ...
    price: 350.0,
    category: 'Oils',
    imageUrl: 'https://placehold.co/400x400/78350F/FFFFFF?text=Coconut+Oil',
  },
  {
    id: 'p5',
    ...
    price: 450.0,
    category: 'Honey',
    imageUrl: 'https://placehold.co/400x400/B45309/FFFFFF?text=Forest+Honey',
  },
  {
    id: 'p6',
    ...
    price: 130.0,
    category: 'Millets',
    imageUrl: 'https://placehold.co/400x400/166534/FFFFFF?text=Ragi',
  },
  {
    id: 'p7',
    name: 'Kodo Millet',
    price: 160.0,
    category: 'Millets',
    imageUrl: 'https://placehold.co/400x400/166534/FFFFFF?text=Kodo+Millet',
  },
  {
    id: 'p8',
    ...
    price: 400.0,
    category: 'Oils',
    imageUrl: 'https://placehold.co/400x400/78350F/FFFFFF?text=Groundnut+Oil',
  },
];
...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  const handleProductClick = () => {
    ...
    // e.g., <Link href={`/product/${product.id}`}>...</Link>
...
const ProdDisplay: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 font-sans text-white">
      ...
      {/* --- Footer --- */}
      <footer className="mt-12 border-t border-gray-700 bg-gray-900">
         <div className="mx-auto max-w-7xl py-8 px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} KrishiShetr. All rights reserved.
            </p>
         </div>
      </footer>
    </div>
